  ...
  return (
    <>
      ...
      <section className="w-full max-w-[1920px] mx-auto mt-[113px] flex justify-center">
        <div className="w-full max-w-[1400px] block  mt-[50px]">
          <div className="w-full  mx-auto flex mt-[27px] ">
            <h1 className={`${style.NavLogo}`}>Savatingiz,</h1>
            <h1 className={`${style.NavLogo} pl-[10px] text-blue-80`}>
              1 ta mahsulot
            </h1>
          </div>
          <div className="w-full flex mt-[100px] ">
            <div className="relative bg-white-50 rounded-[30px]">
              <img
                ...
                alt=""
              />
              <div className="absolute top-[123px] left-[35px] bg-blue-700 rounded-[8px] px-[12px] py-[5px] text-white font-Open-Sans font-semibold leading-[20.43px]">
                Millets
              </div>
            </div>
