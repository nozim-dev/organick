export const style = {
    ...
    // Component style
    NavLink: "text-2xl text-blue-700 font-bold font-Roboto lg1060:text-[18px] lg912:text-[16px] md787:text-[36px] hover:text-green-300 transition cursor-pointer lg1435:text-md md677:text-2xl md787:text-md ",
