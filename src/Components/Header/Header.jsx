    ...
    >
      ...
      >
        ...
        <section className="mdMin787:hidden">
          ...
          <nav
            className={`${isHidden} fixed top-0 left-0 w-full h-[100vh] p-[15px] bg-green-50 z-[100000]`}
          >
            <Link to="/home" className={style.NavLink}>
              Home
            </Link>
            ...
            <label
              htmlFor="search"
              className="w-full max-w-[376px] border border-[#e0e0e0] rounded-[36px] h-[66px] relative lg1060:h-[40px] lg1060:max-w-[230px] lg912:h-[35px] hidden"
            >
              <input
                className={`w-full h-full bg-[#fafafa] rounded-[36px] px-[12px] py-10px pr-[68px] ${style.NavLink} placeholder:font-light lg912:pr-[18px] lg912:placeholder:text-[15px] md787:placeholder:invisible`}
                type="text"
